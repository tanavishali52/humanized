      ...
      <div className="max-w-[900px] w-full bg-white rounded-3xl p-14 shadow-[var(--shadow-card)] border border-[var(--border)]">
        ...
        <article className="flex flex-col gap-6">
          <p className="text-base leading-relaxed text-[var(--muted)]">
            Welcome to <strong className="text-[var(--text)]">Humanize AI</strong>. By accessing or using our website and services, you agree to comply with and be bound by the following Terms of Use. Please review these terms carefully.
          </p>

          <h2 className="text-2xl font-bold text-[var(--text)] font-[var(--font-heading)] mt-4">1. Acceptable Use</h2>
          <p className="text-base leading-relaxed text-[var(--muted)]">You agree to use Humanize AI only for lawful purposes. You must not:</p>
          ...
          <p className="text-base leading-relaxed text-[var(--muted)]">
            All content on this website, including text, graphics, logos, and software, is the property of Humanize AI or its licensors and is protected by intellectual property laws. You retain ownership of any original text you submit, but you grant Humanize AI a license to process it to provide the service.
          </p>

          <h2 className="text-2xl font-bold text-[var(--text)] font-[var(--font-heading)] mt-4">3. Disclaimer of Warranties</h2>
          <p className="text-base leading-relaxed text-[var(--muted)]">
            Humanize AI provides its services &quot;as is&quot; and &quot;as available.&quot; While we strive for high accuracy in AI detection and humanization, we do not guarantee that our results will always be 100% accurate or that humanized text will pass all future AI filters.
          </p>

          <h2 className="text-2xl font-bold text-[var(--text)] font-[var(--font-heading)] mt-4">4. Limitation of Liability</h2>
          <p className="text-base leading-relaxed text-[var(--muted)]">
            Humanize AI shall not be liable for any indirect, incidental, or consequential damages arising from the use of our services, including lost profits or data loss.
          </p>
